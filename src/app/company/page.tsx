      ...
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          ...
          <p className="mt-6 text-sm/6 text-gray-600">
            At AlwaysOn, we are dedicated to transforming the way revenue
...
function Team() {
  return (
    <Container className="mt-32">
      ...
      <Lead className="mt-6 max-w-3xl">
        AlwaysOn is founded by two of the best sellers in the business and backed
      ...
      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div className="max-w-lg">
          ...
          <p className="mt-8 text-sm/6 text-gray-600">
            Today, AlwaysOn transforms revenue organizations by harnessing
            illegally acquired customer and competitor data, using it to provide
            extraordinary leverage. More than 30,000 companies rely on AlwaysOn
