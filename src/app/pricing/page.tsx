...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'Companies all over the world have closed millions of deals with AlwaysOn. Sign up today and start selling smarter.',
}
...
const tiers = [
  {
    ...
    highlights: [
      ...
      { description: 'AlwaysOnAI integrations', disabled: true },
  ...
  },
  {
    ...
    highlights: [
      ...
      { description: 'AlwaysOnAI integrations' },
  ...
  return (
    <Container className="mt-16">
      ...
      <Lead className="mt-6 max-w-3xl">
        Companies all over the world have closed millions of deals with AlwaysOn.
            ...
            <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
              <blockquote>
                <p className="relative text-3xl tracking-tight text-white before:absolute before:-translate-x-full before:content-['“'] after:absolute after:content-['”'] lg:text-4xl">
                  Thanks to AlwaysOn, we&apos;re finding new leads that we never
